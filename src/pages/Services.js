    ...
    <>
      <div className="digital-asset-page">
          ...
          <div className={`icon-menu${menuClass}`}>
              <div className="icon-item" onClick={() => scrollToSection('custody-section')}>
                  <FaShieldAlt className="icon" />
                  <span>Custody</span>
              </div>
              <div className="icon-item" onClick={() => scrollToSection('management-section')}>
                  <FaTasks className="icon" />
                  <span>Management</span>
              </div>
              <div className="icon-item" onClick={() => scrollToSection('opportunities-section')}>
                  <FaChartLine className="icon" />
                  <span>Opportunities</span>
              </div>
              <div className="icon-item" onClick={() => scrollToSection('solutions-section')}>
                  <FaPiggyBank className="icon" />
                  <span>Investment Solutions</span>
              </div>
              <div className="icon-item" onClick={() => scrollToSection('advisory-section')}>
          ...
          {/* First Section */}
         <section id="custody-section" className="custody-section">
...
{/* Management Section */}
<section id="management-section" className="management-section">
 ...
 <section id="opportunities-section" className="custody-section">
  <div className="custody-container">
    {/* Left side - text */}
    <div className="custody-text">
...
{/* Solutions Section */}
<section id="solutions-section" className="management-section">
  <div className="management-container">
    {/* Left side - text */}
    <div className="management-text">
...
<section id="advisory-section" className="custody-section">
  <div className="custody-container">
    {/* Left side - text */}
    <div className="custody-text">
